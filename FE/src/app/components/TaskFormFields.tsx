    ...
    <div className={layoutClassName}>
      <div className="md:col-span-2">
        ...
        <input
          ...
          className={`w-full rounded-xl border-2 px-4 py-3 placeholder:${currentTheme.textMuted} focus:outline-none focus:ring-2 ${currentTheme.focus} focus:border-transparent transition-all ${formFieldSurfaceClassName} ${currentTheme.text} ${
      ...
      <div className="md:col-span-2">
        ...
        <textarea
          ...
          rows={6}
          className={`w-full min-h-24 max-h-48 resize-y rounded-xl border-2 px-4 py-3 placeholder:${currentTheme.textMuted} focus:outline-none focus:ring-2 ${currentTheme.focus} focus:border-transparent transition-all ${formFieldSurfaceClassName} ${currentTheme.text} ${
