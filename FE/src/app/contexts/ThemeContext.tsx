...
export function getThemeColors(theme: Theme, isDarkMode: boolean) {
  const accentThemes = {
    purple: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-purple-400" : "bg-purple-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-purple-400" : "bg-purple-400",
      primaryLimitFullSolid: isDarkMode ? "bg-purple-500" : "bg-purple-600",
    ...
    ocean: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-blue-400" : "bg-blue-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-blue-400" : "bg-blue-400",
      primaryLimitFullSolid: isDarkMode ? "bg-blue-500" : "bg-blue-600",
    ...
    sunset: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-orange-400" : "bg-orange-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-orange-400" : "bg-orange-400",
      primaryLimitFullSolid: isDarkMode ? "bg-orange-500" : "bg-orange-600",
    ...
    forest: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-green-400" : "bg-green-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-green-400" : "bg-green-400",
      primaryLimitFullSolid: isDarkMode ? "bg-green-500" : "bg-green-600",
    ...
    mono: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-gray-400" : "bg-gray-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-gray-400" : "bg-gray-400",
      primaryLimitFullSolid: isDarkMode ? "bg-gray-300" : "bg-gray-700",
    ...
    berry: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-fuchsia-400" : "bg-fuchsia-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-fuchsia-400" : "bg-fuchsia-400",
      primaryLimitFullSolid: isDarkMode ? "bg-fuchsia-500" : "bg-fuchsia-600",
    ...
    lagoon: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-teal-400" : "bg-teal-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-teal-400" : "bg-teal-400",
      primaryLimitFullSolid: isDarkMode ? "bg-teal-500" : "bg-teal-600",
    ...
    citrus: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-lime-400" : "bg-lime-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-lime-400" : "bg-lime-400",
      primaryLimitFullSolid: isDarkMode ? "bg-lime-500" : "bg-lime-600",
    ...
    cobalt: {
      ...
      primaryMutedSolid: isDarkMode ? "bg-indigo-400" : "bg-indigo-400",
      primaryLimitSoftSolid: isDarkMode ? "bg-indigo-400" : "bg-indigo-400",
      primaryLimitFullSolid: isDarkMode ? "bg-indigo-500" : "bg-indigo-600",
